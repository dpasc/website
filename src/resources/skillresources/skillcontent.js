const skill = [
    ...
    },
    {
        ...
        "content": [
            ...
            ".Net development using;ASP.NET MVC,Entity Framework Core,Web API’s and ASP.NET Identity","Scripting using Python,BS4,Pandas and SqlAlchemy","Basic understanding of C language"
        ],
    },
    {
        "id": 2,
    ...
    },
    {
        ...
        "content": [
            ...
            "Well versed in Linux operating systems with the ablility to: Use advanced BASH features,Write BASH Scripts, Configure Apache Server, Configure SMB server, Use SSH and FTP,Set up cron jobs"
    ...
    },
    {
        "id": 4,
        "type": "DevOps",
        "content": ["General understanding of AWS platform including: \n VPC \n EC2 \n RDS \n ElastiCache \n CloudFormation \n S3 \n EFS \n Lambda \n CloudWatch "],
    },
    {
        "id": 5,
        "type": "General",
